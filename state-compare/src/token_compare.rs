...
use concordium_rust_sdk::{
     protocol_level_tokens::{self, TokenState}, types::{
        hashes::BlockHash,
    }, 
...
pub async fn compare_token_identities(
    ...
    // We need to clone the tokens to sort them, otherwise the borrowing would complain
    ...
    info!("tokens_node_1 = {:?}, tokens_node_2 = {:?}",tokens_node_1, tokens_node_2);
