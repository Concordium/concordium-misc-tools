                    ...
                    <div className="containerSpaceBetween">
                        <div style={{ width: '50%', float: 'left' }}>
                            ...
                            {connection && account !== undefined && (
                                <>
                                    ...
                                    <div className="dashedLine" />
                                    <div>
                                        Testing calling a function that calls another smart contract successfully:
                                    </div>
                                    <button
                                        className="buttonStyle"
                                        type="button"
                                    ...
                                    <div className="dashedLine" />
                                    <div>
                                        Testing calling a function that reverts due to an internal call that reverts:
                                    </div>
                                    <button
                                        className="buttonStyle"
                                        type="button"
                        ...
                        <div style={{ width: '50%', float: 'right' }}>
                            ...
                            {!txHash && !transactionError && (
                                <div style={{ color: 'red' }}>
                                    IMPORTANT: After pressing a button that should send a transaction, the transaction
                                    hash or error returned by the wallet are displayed HERE.
                                </div>
                            )}
                            {!txHash && transactionError && (
