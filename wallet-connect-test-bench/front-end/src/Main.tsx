  ...
  return (
    <div className="switch-wrapper">
      ...
      <Switch
        ...
        uncheckedIcon={false}
      />
      <div style={{ fontWeight: hookValue ? "normal" : "bold" }}>
        {downText}
      </div>
    </div>
  );
          ...
          activeConnector && (
            <p>
              ...
              >
                ...
                {!isConnecting &&
                  activeConnectorType === WALLET_CONNECT &&
      ...
      {account && (
        <div className="row">
            ...
            <>
              <div className="col-lg-4">
                <div className="sticky-top">
                  <h5>
                    This column includes various test scenarios that can be
                    executed:{" "}
                  </h5>
                  <ul>
              ...
              <div className="col-lg-4">
                ...
                >
                  <button
                    ...
                    onClick={() => {
                      setTxHash("");
                      setTransactionError("");
                      const tx = initializeWithoutAmountWithoutParameter(
                        connection,
                        account
                      );
                      tx.then(setTxHash).catch((err: Error) =>
                  ...
                  >
                    Initialize smart contract instance (without parameter;
                    without amount)
                  </button>
                </TestBox>
                <TestBox
                ...
                >
                  ...
                  >
                    Initialize smart contract instance with parameter (parameter
                    should be of type `u16`)
                  </button>
                </TestBox>
                <TestBox
          ...
          <div className="col-lg-4">
            <div className="sticky-top">
              <h5>
                This column refreshes every few seconds and displays balances,
                smart contract state, transaction hashes, and error messages.
              </h5>
              ...
              <br />
              <div className="label">
                Smart contract balance (index: {CONTRACT_INDEX.toString()},
                subindex: 0):
              </div>
              <div>
                {smartContractBalance.replace(
                  /(\d)(?=(\d\d\d\d\d\d)+(?!\d))/g,
                  "$1."
                )}{" "}
                CCD
