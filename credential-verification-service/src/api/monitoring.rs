...
pub async fn metrics(State(metrics_registry): State<Arc<Mutex<Registry>>>) -> Result<String, String> {
    let mut buffer = String::new();
    prometheus_client::encoding::text::encode(&mut buffer, &metrics_registry.lock().unwrap())
